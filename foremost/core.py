...
def _build_algorithm(
    ...
    if name == "CTAEA":
        ...
        common_ctaea = {k: v for k, v in common.items() if k != "eliminate_duplicates"}
...
def _run_all_objectives(
    ...
    def _solve(builder, single: bool):
        ...
        return builder.add_restorable_constraint(**cc).solve(
            pop_size=ps, n_gen=ng, seed=sd, verbose=vb, algo=a
        )
